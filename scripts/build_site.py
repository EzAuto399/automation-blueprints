...
.grid{{display:grid;grid-template-columns:1fr 3fr;gap:1.5rem;align-items:start}}
...
.mermaid-holder{{margin:1.1rem 0;background:var(--raised);border:1px solid var(--w12);border-radius:14px;padding:.9rem;overflow:auto}}
...
mermaid.initialize({{startOnLoad:false,theme:'base',themeVariables:{{
  ...
  lineColor:'#5b554c',fontFamily:'system-ui, sans-serif',fontSize:'15px'}}}});
